...
{   
    ...
    if (fullscreen)
    {
        window = glfwCreateWindow(1024, 800, "Surface Of Revolution", glfwGetPrimaryMonitor(), nullptr);
    }
    else
    {
        window = glfwCreateWindow(1024, 800, "Surface Of Revolution", nullptr, nullptr);
    }
    if (nullptr == window) 
    {
