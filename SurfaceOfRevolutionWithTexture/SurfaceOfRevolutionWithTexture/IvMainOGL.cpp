...
{   
    ...
    if (fullscreen)
    {
        window = glfwCreateWindow(1024, 800, "Surface of Revolution with Texture", glfwGetPrimaryMonitor(), nullptr);
    }
    else
    {
        window = glfwCreateWindow(1024, 800, "Surface of Revolution with Texture", nullptr, nullptr);
    }
    if (nullptr == window) 
    {
    ...
    IvRenderer::mRenderer->SetClearColor( 0.8f, 0.8f, 0.8f, 1.0f );
